...
# Data points for the green line (Capital)
x_green = [0, 0.5, 1, 5]
y_green = [0.35, 0.65, 0.645, 0.5]

# Data points for the magenta line (Capital 2)
x_magenta = [0, 0.5, 1, 5]
y_magenta = [0.17, 0.33, 0.33, 0.3]

# Data points for the blue line (Capital 1)
x_blue = [0, 0.5, 1, 5]
y_blue = [0.165, 0.3, 0.29, 0.25]

# Plot the lines
plt.plot(x_blue, y_blue, ':', color='cyan', label='Capital 1', linewidth=2)
plt.plot(x_magenta, y_magenta,'m-.', label='Capital 2', linewidth=2)
plt.plot(x_green, y_green, color='green', label='Capital', linewidth=2)
...
# Data points for the green line (Capital)
x_green = [0, 0.5, 5]
y_green = [0.92, 0.89, 0.45]

# Data points for the magenta line (Capital 2)
x_magenta = [0, 0.5, 1, 5]
y_magenta = [0, 0.18, 0.2, 0.19]
...
# Plot the lines
plt.plot(x_blue, y_blue, ':', color='cyan', label='labor 1', linewidth=2)
plt.plot(x_magenta, y_magenta, 'm-.', label='labor 2', linewidth=2)
plt.plot(x_green, y_green, color='green', label='labor', linewidth=2)
...
# Data points for the green line (Capital)
x_green = [0, 0.5, 1, 5]
y_green = [0.78, 0.65, 0.58, 0.45]

# Data points for the magenta line (Capital 2)
x_magenta = [0, 0.5, 1, 5]
y_magenta = [0.72, 0.5, 0.4, 0.35]

# Data points for the blue line (Capital 1)
x_blue = [0, 0.5, 1, 5]
y_blue = [0.05, 0.12, 0.15, 0.18 ]
